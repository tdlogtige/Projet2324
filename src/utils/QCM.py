...
def ask_qcm_prime(subject,level,prompt):
    contexte = f'L objectif est de faire réviser l élève sur des cours de {subject} de classe de {level}, en prenant comme sujet {prompt}. Utilise latex pour les équations mathématiques'
